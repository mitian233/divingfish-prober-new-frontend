...
<div>
  ...
  <h2 class="text-lg font-bold">“登录并同步数据”按钮</h2>
  <p>
    <b>注册新账号在这个按钮里面。</b>
  </p>
  <h2 class="text-lg font-bold">“导入数据”按钮</h2>
  <p>
    仅在使用方法二导入数据时使用。粘贴舞萌DX网页指定页面的源代码即可导入数据。
  </p>
  <h2 class="text-lg font-bold">“提交反馈”按钮</h2>
  <p>
    如果在使用本网页时出现了问题，或者对查分器有任何建议，可以点击按钮提交反馈给网页开发者。
  </p>
  <h2 class="text-lg font-bold">“导出为CSV”按钮</h2>
  <p>
    如果本网页的数据处理不能使你满意，可以点击导出为CSV并使用Excel等软件打开处理。
  </p>
  <h2 class="text-lg font-bold">“牌子查询”按钮</h2>
  <p>
    登录账号或导入数据后，可以点击按钮查询部分版本的Basic~Master制霸情况。
  </p>
  <h2 class="text-lg font-bold">“计算工具”按钮</h2>
  <p>
    点击本按钮后，可以在弹出的界面内进行一些maimai相关的实用计算。可以通过成绩表格中“编辑”一列中的计算器
    按钮快速填入相应谱面的数据。在使用计算器
  ...
  <h2 class="text-lg font-bold">“解锁全曲”按钮</h2>
  <p>
  ...
  <h2 class="text-lg font-bold">“编辑个人资料”按钮</h2>
  <p>
  ...
  <h2 class="text-lg font-bold">成绩表格设置</h2>
  ...
  <p>
    首先是四种筛选，点击右侧的色块可以选择过滤对应的条目。可以点击
    按钮来全选/全不选。下面的两个选择栏可以选择对应的版本/歌曲分类，选择后可以点击选择栏内右侧的
    按钮来清除对应的筛选。
  </p>
  <p>
    接下来是“选择分数表列”选择栏，可以在这里选择各种分数表列是否显示（如：可以取消勾选“相对难度”复选框来隐藏相对难度列）。点击右侧的
    按钮可以把当前的分数表列设置保存为默认值，这样取消勾选“使用高级设置”甚至刷新页面后，分数表列设置都会保留。左侧的
    按钮可以把分数表列设置重置为设置好的默认值。
  </p>
  <p>
    最后是“使用暗色主题”复选框，勾选后本网页将呈现黑色背景，保护眼睛。本设置也会在取消勾选“使用高级设置”甚至刷新页面后保留。
  </p>
  <h2 class="text-lg font-bold">成绩表格</h2>
  <p>
  ...
  <p>
    点击编辑
    按钮可以在弹窗中手动修改单个条目的成绩（如出勤时刷分后可以通过编辑
    按钮更改到最新分数），但FC/AP图标、FS/FDX图标和DX分数等其他信息均不会更改。注意通过“解锁全曲”按钮接锁的曲目不能通过编辑
    按钮编辑。
  </p>
  <p>
    计算器
